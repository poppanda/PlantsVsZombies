...
public class CherryBomb  extends JPanel{
	...
	public static ImageIcon peasicon=new ImageIcon("CherryBomb/CherryBomb_0.png");
			...
			/*	if(coor.x[0] >= coor.x[2]){
				...
				*/
				while(true) {
		    		...
		    		String path="CherryBomb/boom/Frame"+idx+".png";
					ImageIcon pea=new ImageIcon(path);
					peas.setIcon(pea);
					if(idx<19) {
						idx += 1;
